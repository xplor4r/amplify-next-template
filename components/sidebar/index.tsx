...
const settingsLinks = [
	{ href: 'mailto:sujay.kundu@publicissapient.com', name: 'Support', Icon: SupportIcon },
					...
					<div className="flex h-full flex-col items-center justify-between">
						<div className="flex flex-col items-center">
							<Link
								// onClick={() => setShow(false)}
								href="/dashboard"
								className="mt-[3px] active:scale-95  text-white rounded-lg p-1 transition-all focus:outline-none"
							>   
								WAI 
							</Link>
